...
const DEMO_DATA = {
  AAPL: {
    ...
    esgColor: 'green',
    esgText: '🌱 Green (Low Risk)',
    momEsgBadge: '🌱 ESG: Green (Low Risk)',
    profi: {
      thesisText: 'Apple combines a top-tier balance sheet ($162B cash) with high-margin Services software growth and pristine ESG score (Top 8% Sector Rating).',
      rsi: 58.4,
      rsiCategory: 'neutral',
      rsiStatus: 'Neutral / Healthy (58.4)',
      rsiDesc: 'Buying momentum is steady and healthy. Not overextended.',
      targetValue: '$215.00',
      targetPill: '🚀 +13.2% Analyst Target Upside',
      targetClass: 'positive',
      targetDesc: '88% of Wall Street research desks rate as Strong Buy / Outperform.',
      peValue: '29.8x',
      pePill: '📊 PEG Ratio: 1.25x (Quality Premium)',
      peClass: 'neutral',
      peDesc: 'Valuation is backed by expanding high-margin Services subscription cash flow.',
      shortValue: '0.8%',
      shortPill: '🛡️ Extremely Low Squeeze Risk',
      shortClass: 'positive',
      shortDesc: 'Minimal hedge fund short interest (0.5 days to cover).',
      sma50: '$184.20',
      sma50Pill: '🟢 Price +3.1% Above SMA 50',
      sma50Class: 'positive',
      sma50Desc: 'Trading above 50-day moving average confirms short-term trend.',
      sma200: '$176.50',
      sma200Pill: '🟢 Price +7.6% Above SMA 200',
      sma200Class: 'positive',
      sma200Desc: 'Maintains primary multi-year structural bull trend.',
      beta: '1.02',
      betaPill: '⚡ Low Volatility relative to Tech',
      betaClass: 'neutral',
      betaDesc: 'Stock moves in steady harmony with broader S&P 500 index.',
      macd: '+2.15',
      macdPill: '📈 Bullish Crossover Signal',
      macdClass: 'positive',
      macdDesc: 'MACD line sits above signal line, confirming active buyer interest.',
      instValue: '62.8%',
      instPill: '🏛️ High Institutional Backing',
      instClass: 'positive',
      instDesc: 'Massive long-term accumulation by Vanguard, BlackRock, and Berkshire Hathaway.',
      evebitdaValue: '22.4x',
      evebitdaPill: '💰 4.2% FCF Yield to Firm',
      evebitdaClass: 'positive',
      evebitdaDesc: 'Robust cash generation and massive liquidity cushion.',
      roicValue: '54.2% ROIC',
      roicPill: '🏰 Unmatched Economic Moat',
      roicClass: 'positive',
      roicDesc: 'Generates $54.20 in operating profit per $100 of capital deployed.',
      ivValue: '21.2% IV',
      ivPill: '⚡ Expected Move: ±3.8%',
      ivClass: 'neutral',
      ivDesc: 'Options pricing reflects calm market expectations.',
      leverageValue: '0.72x',
      leveragePill: '🟢 Net Cash Position',
      leverageClass: 'positive',
      leverageDesc: 'Cash reserves far exceed total debt obligations.',
      insiderValue: 'Net Holding',
      insiderPill: '👔 Executive Retention High',
      insiderClass: 'positive',
      insiderDesc: 'Leadership team holds substantial long-term equity grants.',
      esgScore: '16.2 / 100',
      esgPill: '🌱 Low ESG Risk (Top 8% Sector Rating)',
      esgClass: 'positive',
      esgE: '🍃 Env: 8.4/10',
      esgS: '👥 Soc: 7.9/10',
      esgG: '🏛️ Gov: 9.1/10',
      esgDesc: '100% carbon neutral corporate operations target by 2030, clean hardware recycling supply chains, and high SFDR Article 8/9 institutional fund compliance.'
    },
...
Apple is widely regarded as a low-to-moderate risk holding suitable for steady long-term capital preservation and steady wealth growth.`,
  ...
  TSLA: {
    ...
    esgColor: 'yellow',
    esgText: '🟡 Yellow (Moderate Risk)',
    momEsgBadge: '🟡 ESG: Yellow (Moderate Risk)',
    profi: {
      thesisText: 'Tesla combines world-class Environmental carbon reduction with ongoing governance monitoring around board independence and key-person executive risk.',
      rsi: 42.1,
      rsiCategory: 'neutral',
      rsiStatus: 'Neutral / Cooling (42.1)',
      rsiDesc: 'RSI indicates price cooling off after recent rallies.',
      targetValue: '$260.00',
      targetPill: '🚀 +19.0% Analyst Target Upside',
      targetClass: 'positive',
      targetDesc: 'Wide analyst price target range ($120 to $350) reflecting high innovation variance.',
      peValue: '58.2x',
      pePill: '⚡ Forward P/E: 42.0x',
      peClass: 'neutral',
      peDesc: 'Valuation reflects growth expectations for energy storage and autonomous driving.',
      shortValue: '3.4%',
      shortPill: '⚡ Moderate Short Interest',
      shortClass: 'neutral',
      shortDesc: '$23.6B short position by hedge funds (1.8 days to cover).',
      sma50: '$224.50',
      sma50Pill: '🟡 Price -2.7% Below SMA 50',
      sma50Class: 'neutral',
      sma50Desc: 'Trading slightly below short-term moving average.',
      sma200: '$208.10',
      sma200Pill: '🟢 Price +4.9% Above SMA 200',
      sma200Class: 'positive',
      sma200Desc: 'Maintains long-term trend support above 200-day moving average.',
      beta: '2.14',
      betaPill: '🎢 High Volatility (Beta 2.14)',
      betaClass: 'caution',
      betaDesc: 'Stock moves twice as aggressively as the general S&P 500 market.',
      macd: '-1.45',
      macdPill: '🔻 Consolidation Phase',
      macdClass: 'neutral',
      macdDesc: 'Momentum indicators reflect near-term price consolidation.',
      instValue: '44.2%',
      instPill: '🏛️ Moderate Institutional Base',
      instClass: 'neutral',
      instDesc: 'High retail investor ownership alongside institutional index funds.',
      evebitdaValue: '32.1x',
      evebitdaPill: '⚡ High Growth Multiple',
      evebitdaClass: 'neutral',
      evebitdaDesc: 'Enterprise value reflects software and energy storage pipeline.',
      roicValue: '14.8% ROIC',
      roicPill: '🏰 Solid Capital Efficiency',
      roicClass: 'positive',
      roicDesc: 'High EV gigafactory manufacturing capital efficiency.',
      ivValue: '48.2% IV',
      ivPill: '⚡ High Options Volatility',
      ivClass: 'caution',
      ivDesc: 'Options straddles price in significant expected move around vehicle delivery reports.',
      leverageValue: '0.12x',
      leveragePill: '🟢 Pristine Cash Balance',
      leverageClass: 'positive',
      leverageDesc: 'Over $29B in cash reserves providing strong liquidity.',
      insiderValue: 'Key Executive',
      insiderPill: '👔 Key-Person Executive Focus',
      insiderClass: 'neutral',
      insiderDesc: 'Board governance focused on CEO key-person retention and compensation.',
      esgScore: '28.5 / 100',
      esgPill: '⚡ High E Score / Governance Watch',
      esgClass: 'neutral',
      esgE: '🍃 Env: 9.4/10',
      esgS: '👥 Soc: 6.2/10',
      esgG: '🏛️ Gov: 5.5/10',
      esgDesc: 'World-class clean energy carbon offset offset by ongoing governance scrutiny around board independence and factory labor practices.'
    },
...
Best suited for growth-focused investors who are comfortable with temporary price swings and believe in long-term electrification.`,
  ...
  NVDA: {
    ...
    momEsgBadge: '🌱 ESG: Green (Low Risk)',
    profi: {
      thesisText: 'NVIDIA commands 85%+ AI accelerator market share with high ROIC (62.4%) and top-tier ESG employee retention and energy efficiency scores.',
      rsi: 66.8,
      rsiCategory: 'neutral',
      rsiStatus: 'Neutral / Strong Bullish (66.8)',
      rsiDesc: 'RSI reflects robust buying momentum without entering extreme overbought zone (>70).',
      targetValue: '$150.00',
      targetPill: '🚀 +20.5% Analyst Target Upside',
      targetClass: 'positive',
      targetDesc: 'Over 92% of research desks rate as Strong Buy / Outperform.',
      peValue: '45.1x',
      pePill: '📊 PEG Ratio: 0.88x (Growth Discount)',
      peClass: 'positive',
      peDesc: 'PEG ratio below 1.0x indicates valuation is cheap relative to 125% EPS growth.',
      shortValue: '1.1%',
      shortPill: '🛡️ Low Short Exposure',
      shortClass: 'positive',
      shortDesc: 'Minimal hedge fund short positioning.',
      sma50: '$118.20',
      sma50Pill: '🟢 Price +5.3% Above SMA 50',
      sma50Class: 'positive',
      sma50Desc: 'Trading above 50-day moving average confirms momentum.',
      sma200: '$98.40',
      sma200Pill: '🟢 Price +26.5% Above SMA 200',
      sma200Class: 'positive',
      sma200Desc: 'Strong structural primary bull market trend.',
      beta: '1.68',
      betaPill: '⚡ High Beta Growth',
      betaClass: 'neutral',
      betaDesc: 'Price moves 1.68x relative to general market index.',
      macd: '+3.42',
      macdPill: '📈 Bullish Momentum Crossover',
      macdClass: 'positive',
      macdDesc: 'Active buying surge in GPU hardware sector.',
      instValue: '67.4%',
      instPill: '🏛️ Heavy Institutional Ownership',
      instClass: 'positive',
      instDesc: 'Core holding across sovereign wealth, pension funds, and tech mutual funds.',
      evebitdaValue: '36.2x',
      evebitdaPill: '💰 3.8% FCF Yield to Firm',
      evebitdaClass: 'positive',
      evebitdaDesc: 'Massive cash generation from 75%+ gross margin data center GPU sales.',
      roicValue: '62.4% ROIC',
      roicPill: '🏰 Unrivaled Software Moat',
      roicClass: 'positive',
      roicDesc: 'CUDA software platform guarantees world-class return on invested capital.',
      ivValue: '38.5% IV',
      ivPill: '⚡ Earnings Volatility Expected',
      ivClass: 'neutral',
      ivDesc: 'Options market prices moderate volatility around quarterly earnings announcements.',
      leverageValue: '0.18x',
      leveragePill: '🟢 Pristine Net Cash Balance',
      leverageClass: 'positive',
      leverageDesc: 'Over $34B cash reserves with minimal debt.',
      insiderValue: 'Net Holding',
      insiderPill: '👔 Founder-Led Execution',
      insiderClass: 'positive',
      insiderDesc: 'CEO Jensen Huang holds substantial founder equity stake.',
      esgScore: '14.8 / 100',
      esgPill: '🌱 Low ESG Risk (Top 5% Tech Rating)',
      esgClass: 'positive',
      esgE: '🍃 Env: 8.1/10',
      esgS: '👥 Soc: 8.6/10',
      esgG: '🏛️ Gov: 8.9/10',
      esgDesc: 'High scores across employee retention and renewable energy data center initiatives with low carbon intensity.'
    },
...
NVIDIA offers industry-leading growth backed by massive cash profits, though investors should expect normal pullbacks after huge historical rallies.`,
  ...
  KO: {
    ...
    momEsgBadge: '🟡 ESG: Yellow (Moderate Risk)',
    profi: {
      thesisText: 'Coca-Cola provides classic high ROIC (18.2%) defensive dividend income, combining water replenishment initiatives with packaging sustainability monitoring.',
      rsi: 54.2,
      rsiCategory: 'neutral',
      rsiStatus: 'Neutral / Healthy (54.2)',
      rsiDesc: 'Buying momentum is steady and stable.',
      targetValue: '$74.00',
      targetPill: '🚀 +8.5% Analyst Target Upside',
      targetClass: 'positive',
      targetDesc: '82% of Wall Street research desks rate as Buy / Outperform.',
      peValue: '24.2x',
      pePill: '📊 Forward P/E: 21.5x',
      peClass: 'neutral',
      peDesc: 'Fair defensive valuation for 60+ year Dividend King.',
      shortValue: '0.6%',
      shortPill: '🛡️ Minimal Short Interest',
      shortClass: 'positive',
      shortDesc: 'Negligible short interest from institutional desks.',
      sma50: '$66.80',
      sma50Pill: '🟢 Price +2.1% Above SMA 50',
      sma50Class: 'positive',
      sma50Desc: 'Trading smoothly above 50-day moving average.',
      sma200: '$62.10',
      sma200Pill: '🟢 Price +9.8% Above SMA 200',
      sma200Class: 'positive',
      sma200Desc: 'Solid upward low-volatility trendline.',
      beta: '0.58',
      betaPill: '🧘 Ultra-Low Volatility (Beta 0.58)',
      betaClass: 'positive',
      betaDesc: 'Price fluctuates almost 50% less than general S&P 500 market dips.',
      macd: '+0.45',
      macdPill: '📈 Steady Upward Trend',
      macdClass: 'positive',
      macdDesc: 'Calm buying momentum.',
      instValue: '71.2%',
      instPill: '🏛️ High Institutional Income Ownership',
      instClass: 'positive',
      instDesc: 'Major long-term holdings by Berkshire Hathaway and dividend mutual funds.',
      evebitdaValue: '18.4x',
      evebitdaPill: '💰 4.8% Free Cash Flow Yield',
      evebitdaClass: 'positive',
      evebitdaDesc: 'High cash conversion supporting $8B+ annual dividend distribution.',
      roicValue: '18.2% ROIC',
      roicPill: '🏰 Unassailable Distribution Moat',
      roicClass: 'positive',
      roicDesc: 'High operating efficiency backed by world-famous brand portfolio.',
      ivValue: '14.2% IV',
      ivPill: '⚡ Low Volatility Percentile',
      ivClass: 'positive',
      ivDesc: 'Options pricing reflects minimal price fluctuation risk.',
      leverageValue: '1.45x',
      leveragePill: '🟢 Healthy Balance Sheet',
      leverageClass: 'positive',
      leverageDesc: 'Manageable debt structure with steady cash coverage.',
      insiderValue: 'Net Holding',
      insiderPill: '👔 Stable Corporate Leadership',
      insiderClass: 'positive',
      insiderDesc: 'Long-tenured management team with aligned shareholder payouts.',
      esgScore: '23.4 / 100',
      esgPill: '💧 Water Neutral / Packaging Watch',
      esgClass: 'neutral',
      esgE: '🍃 Env: 6.8/10',
      esgS: '👥 Soc: 8.2/10',
      esgG: '🏛️ Gov: 8.8/10',
      esgDesc: 'Solid governance and global community water replenishment programs offset by environmental focus on single-use plastic packaging.'
    },
...
const DOM = {
  ...
  resEsgOverviewBadge: document.getElementById('res-esg-overview-badge'),
  resEsgBadge: document.getElementById('res-esg-badge'),
  resEsgScoreValue: document.getElementById('res-esg-score-value'),
  resEsgPill: document.getElementById('res-esg-pill'),
  resEsgE: document.getElementById('res-esg-e'),
  resEsgS: document.getElementById('res-esg-s'),
  resEsgG: document.getElementById('res-esg-g'),
  resEsgDesc: document.getElementById('res-esg-desc'),
...
function renderStockResults(data) {
  ...
  // ESG Overview for Non-Finance Investors
  const esgColor = data.esgColor || 'green';
  const esgText = data.esgText || (esgColor === 'green' ? '🌱 Green (Low Risk)' : (esgColor === 'yellow' ? '🟡 Yellow (Moderate Risk)' : '🔴 Red (High Risk)'));
  if (DOM.resEsgOverviewBadge) {
    DOM.resEsgOverviewBadge.textContent = esgText;
    DOM.resEsgOverviewBadge.className = `esg-overview-badge esg-${esgColor}`;
  }
  ...
  if (DOM.resEsgBadge) {
    DOM.resEsgBadge.textContent = data.momEsgBadge || `🌱 ESG: ${esgColor === 'green' ? 'Green (Low Risk)' : (esgColor === 'yellow' ? 'Yellow (Moderate Risk)' : 'Red (High Risk)')}`;
    DOM.resEsgBadge.className = `verdict-pill esg-pill ${esgColor === 'green' ? 'positive' : (esgColor === 'yellow' ? 'neutral' : 'warning')}`;
  }
...
function renderProfiIndicatorsCard(data) {
  ...
  if (DOM.resEsgScoreValue) DOM.resEsgScoreValue.textContent = profi.esgScore || '16.2 / 100';
  if (DOM.resEsgPill) {
    DOM.resEsgPill.textContent = profi.esgPill || '🌱 Low ESG Risk (Top 8% Sector Score)';
    DOM.resEsgPill.className = `profi-status-pill ${profi.esgClass || 'positive'}`;
  }
  if (DOM.resEsgE) DOM.resEsgE.textContent = profi.esgE || '🍃 Env: 8.4/10';
  if (DOM.resEsgS) DOM.resEsgS.textContent = profi.esgS || '👥 Soc: 7.9/10';
  if (DOM.resEsgG) DOM.resEsgG.textContent = profi.esgG || '🏛️ Gov: 9.1/10';
  if (DOM.resEsgDesc) DOM.resEsgDesc.textContent = profi.esgDesc || 'Strong ethical governance, 100% carbon neutral target by 2030, and high compliance with SFDR Article 8/9 institutional funds.';
}
...
function getProfiMetrics(stock) {
  ...
  return {
    ...
    esgScore: '16.2 / 100',
    esgPill: '🌱 Low ESG Risk (Top 8% Sector Score)',
    esgClass: 'positive',
    esgE: '🍃 Env: 8.4/10',
    esgS: '👥 Soc: 7.9/10',
    esgG: '🏛️ Gov: 9.1/10',
    esgDesc: 'Strong ethical governance, 100% carbon neutral target by 2030, and high compliance with SFDR Article 8/9 institutional funds.'
  };
}
